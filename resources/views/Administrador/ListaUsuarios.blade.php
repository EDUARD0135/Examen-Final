                                        ...
                                        <td>
                                            @if ($usuario->activo)
                                                <a class="btn btn-outline-primary btn-custom"
                                                    href="{{ route('activar.desactivar.usuario', ['id' => $usuario->id]) }}"><i
                                                        class="fas fa-toggle-off"></i> Habilitado</a>
                                            @else
                                                <a class="btn btn-outline-danger btn-custom"
                                                    href="{{ route('activar.desactivar.usuario', ['id' => $usuario->id]) }}"><i
                                                        class="fas fa-toggle-on"></i> Deshabilitado</a>
                                            @endif
                                        </td>
                                        <td>
