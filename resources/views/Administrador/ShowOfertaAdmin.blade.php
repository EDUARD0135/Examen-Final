                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <h1 class="h2" style="color: #2f2c79; text-align: justify; width: 590px;"><b>{{ $oferta->nombre }}</b></h1>
                            ...
                            <h6><b>Vendedor:</b></h6>
                            @if ($oferta->usuario)
                                <p><a class="text-decoration-none" style="color:black" href="{{ route('usuario.mostrar', ['id' => $oferta->usuario_id]) }}">{{ $oferta->usuario->nombre ?? 'Nombre no disponible' }}
                        ...
                        <li class="list-group-item comment-card">
                            ...
                            <div class="comment-content">
                                <p class="comment-username">
                                    ...
                                    <a href="{{ route('usuario.mostrar', ['id' => $comentario->usuario->id]) }}" style="color: #2f2c79"
