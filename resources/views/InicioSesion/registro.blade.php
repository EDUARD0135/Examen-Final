                ...
                <div class="card">
                    ...
                    <form method="post" enctype="multipart/form-data" onsubmit="return validarFormulario()">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    @error('nombre')
                                        <div class ="invalid-feedback">No se aceptan Numeros ni caracteres especiales</div>
                                    @enderror

                                </div>
                                <div class="col">
                                    <input class="form-control @error('apellido') is-invalid @enderror" type="text"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col">
                                    <input class="form-control @error('nombre_usuario') is-invalid @enderror" type="text"
                                        id="nombre_usuario" name="nombre_usuario" required
                                        placeholder="Escribir Nombre de Usuario" value="{{ old('nombre_usuario') }}">
                                ...
                                <div class="col">
                                    <input class="form-control @error('repite_nombre_usuario') is-invalid @enderror"
                                        type="text" id="repite_nombre_usuario" name="repite_nombre_usuario" required
                                        placeholder="Repetir Nombre de Usuario" value="{{ old('repite_nombre_usuario') }}">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="input-group">
                                        ...
                                        @error('contrasena')
                                            <div class ="invalid-feedback">La Contraseña debe tener letras Minisculas minimo una
                                ...
                                <div class="col">
                                    <div class="input-group">
                                        <input class="form-control @error('repite_contrasena') is-invalid @enderror"
                                            type="password" id="repite_contrasena" name="repite_contrasena" required
